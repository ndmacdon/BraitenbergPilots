...
class BraitenbergVehicle {
  ...
  // Useful to avoid seizure-states
  ...
  float   getTurnLeft()     { return turnLeft; }
  float   getTurnRight()    { return turnRight; }
  float   getAccForward()   { return accForward; }
  float   getAccBackward()  { return accBackward; }
...
public class Asteroids extends Applet implements Runnable, KeyListener {
  ...
  public void initShip() {
    ...
    pilot = new BraitenbergVehicle(currentState);
  }
